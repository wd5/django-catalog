...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CatalogPostImages.post'
        db.alter_column('catalog_catalogpostimages', 'post_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.CatalogPost'], null=True))

    def backwards(self, orm):

        # Changing field 'CatalogPostImages.post'
        db.alter_column('catalog_catalogpostimages', 'post_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.CatalogPost']))
