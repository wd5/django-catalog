...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CatalogPostImages.post'
        db.add_column('catalog_catalogpostimages', 'post',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['catalog.CatalogPost']),
                      keep_default=False)

        # Adding field 'CatalogPostImages.description'
        db.add_column('catalog_catalogpostimages', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CatalogPostImages.post'
        db.delete_column('catalog_catalogpostimages', 'post_id')

        # Deleting field 'CatalogPostImages.description'
        db.delete_column('catalog_catalogpostimages', 'description')
    ...
    models = {
        ...
        'catalog.catalogpostimages': {
            ...
            'post': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'to': "orm['catalog.CatalogPost']"})
        },
