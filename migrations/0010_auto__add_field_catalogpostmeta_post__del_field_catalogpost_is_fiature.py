...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CatalogPostMeta.post'
        db.add_column('catalog_catalogpostmeta', 'post',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.CatalogPost'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field post on 'CatalogPostMeta'
        db.delete_table('catalog_catalogpostmeta_post')

        # Deleting field 'CatalogPost.is_fiatured'
        db.delete_column('catalog_catalogpost', 'is_fiatured')

        # Adding field 'CatalogPost.is_featured'
        db.add_column('catalog_catalogpost', 'is_featured',
                      self.gf('django.db.models.fields.NullBooleanField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CatalogPostMeta.post'
        db.delete_column('catalog_catalogpostmeta', 'post_id')

        # Adding M2M table for field post on 'CatalogPostMeta'
        db.create_table('catalog_catalogpostmeta_post', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('catalogpostmeta', models.ForeignKey(orm['catalog.catalogpostmeta'], null=False)),
            ('catalogpost', models.ForeignKey(orm['catalog.catalogpost'], null=False))
        ))
        db.create_unique('catalog_catalogpostmeta_post', ['catalogpostmeta_id', 'catalogpost_id'])

        # Adding field 'CatalogPost.is_fiatured'
        db.add_column('catalog_catalogpost', 'is_fiatured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'CatalogPost.is_featured'
        db.delete_column('catalog_catalogpost', 'is_featured')
    ...
    models = {
        ...
        'catalog.catalogpostmeta': {
            'Meta': {'object_name': 'CatalogPostMeta'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.CatalogPost']", 'null': 'True', 'blank': 'True'}),
